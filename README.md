...
- TODO: Fix the cookie jwt error----fixed the server error for now-----go back to implementing the ticketing and ticket cart feature-----try to implement some kind of dashboard with stats and chart 
